<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="PrintCertificate.aspx.vb" Inherits="Trainee.PrintCertificate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h1>Print Cerificate</h1>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT Student.Name, Student.Course, Student.Year, Student.Col, Student.University, TraineeDuration.Period as Duration, TraineeDuration.JoinDate, TraineeDuration.EndDate FROM Student INNER JOIN TraineeDuration ON Student.StudentID = TraineeDuration.TraineeID WHERE (TraineeDuration.EndDate = @Date)">
                        <SelectParameters>
